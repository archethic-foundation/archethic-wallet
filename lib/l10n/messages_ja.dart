...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "aboutGeneralTermsAndConditions":
            MessageLookupByLibrary.simpleMessage("一般利用規約"),
        ...
        "aboutWalletServiceTerms":
            MessageLookupByLibrary.simpleMessage("ウォレットサービス規約"),
        "ackBackedUp": MessageLookupByLibrary.simpleMessage(
            "あなたはあなたの秘密のフレーズをバックアップしたと確信していますか？"),
        ...
        "addNFTConfirmationMessage":
            MessageLookupByLibrary.simpleMessage("次のNFTの作成を確認しますか？"),
        "addNFTHeader": MessageLookupByLibrary.simpleMessage("NFTを追加する"),
        "addressBookDesc":
            MessageLookupByLibrary.simpleMessage("頻繁に使用するアドレスを作成および管理する"),
        ...
        "backupSafetyLabel1":
            MessageLookupByLibrary.simpleMessage("次の画面に、回復フレーズが表示されます。"),
        "backupSafetyLabel2":
            MessageLookupByLibrary.simpleMessage("回復フレーズとは何ですか？"),
        ...
        "backupSafetyLabel4":
            MessageLookupByLibrary.simpleMessage("バックアップする方法は？"),
        ...
        "backupSafetyLabel6":
            MessageLookupByLibrary.simpleMessage("安全でないバックアップ方法"),
        "backupSafetyLabel7":
            MessageLookupByLibrary.simpleMessage("1.スクリーンショット\n2.写真を撮る"),
        "backupSecretPhrase":
            MessageLookupByLibrary.simpleMessage("バックアップの秘密のフレーズ"),
        "biometricsMethod": MessageLookupByLibrary.simpleMessage("生体認証"),
        "cancel": MessageLookupByLibrary.simpleMessage("キャンセル"),
        "changeCurrencyDesc":
            MessageLookupByLibrary.simpleMessage("UCOと一緒に表示する法定通貨を選択します"),
        ...
        "contactNameMissing":
            MessageLookupByLibrary.simpleMessage("この連絡先の名前を選択してください"),
        "contactRemoved":
            MessageLookupByLibrary.simpleMessage("%1が名簿から削除されました！"),
        ...
        "iUnderstandTheRisks":
            MessageLookupByLibrary.simpleMessage("私はリスクを理解している"),
        "importSecretPhrase":
            MessageLookupByLibrary.simpleMessage("シークレットフレーズのインポート"),
        "importSecretPhraseHint": MessageLookupByLibrary.simpleMessage(
            "以下に24語の秘密のフレーズを入力してください。各単語はスペースで区切る必要があります。"),
        ...
        "iveBackedItUp":
            MessageLookupByLibrary.simpleMessage("私はそれをバックアップしました"),
        ...
        "logoutDetail": MessageLookupByLibrary.simpleMessage(
            "ログアウトすると、このデバイスからすべてのARCHEthicWallet関連のデータが削除されます。あなたの秘密のフレーズがバックアップされていない場合、あなたはあなたの財布に二度とアクセスすることができなくなります"),
        "logoutReassurance": MessageLookupByLibrary.simpleMessage(
            "シードをバックアップしている限り、心配する必要はありません。"),
        ...
        "mnemonicSizeError":
            MessageLookupByLibrary.simpleMessage("秘密のフレーズには24語しか含めることができません"),
        ...
        "nftInitialSupplyHint":
            MessageLookupByLibrary.simpleMessage("初期供給を入力してください"),
        "nftInitialSupplyMissing":
            MessageLookupByLibrary.simpleMessage("NFTの初期供給を選択します"),
        "nftInitialSupplyPositive":
            MessageLookupByLibrary.simpleMessage("初期供給は> 0である必要があります"),
        "nftName": MessageLookupByLibrary.simpleMessage("Name: "),
        "nftNameHint": MessageLookupByLibrary.simpleMessage("名前を入力してください"),
        "nftNameMissing":
            MessageLookupByLibrary.simpleMessage("NFTの名前を選択してください"),
        ...
        "nodeAverageAvailability":
            MessageLookupByLibrary.simpleMessage("平均可用性："),
        ...
        "pinSecretPhraseBackup": MessageLookupByLibrary.simpleMessage(
            "秘密のフレーズをバックアップするためにPINを入力してください"),
        "preferences": MessageLookupByLibrary.simpleMessage("設定"),
        "qrInvalidAddress":
            MessageLookupByLibrary.simpleMessage("QRコードに有効な宛先が含まれていません"),
        "qrInvalidPermissions": MessageLookupByLibrary.simpleMessage(
            "QRコードをスキャンするためのカメラ権限を付与してください"),
        "qrMnemonicError":
            MessageLookupByLibrary.simpleMessage("QRに有効な秘密のフレーズが含まれていません"),
        "qrUnknownError":
            MessageLookupByLibrary.simpleMessage("QRコードを読み取れませんでした"),
        "recentTransactionsHeader":
            MessageLookupByLibrary.simpleMessage("最近の取引"),
        ...
        "rootWarning": MessageLookupByLibrary.simpleMessage(
            "お使いのデバイスが「ルート化」、「ジェイルブレイク」、またはセキュリティを危険にさらすような方法で変更されているようです。続行する前に、デバイスを元の状態にリセットすることをお勧めします。"),
        "scanQrCode": MessageLookupByLibrary.simpleMessage("QRコードをスキャン"),
        "secretWarning": MessageLookupByLibrary.simpleMessage(
            "デバイスを紛失したり、アプリケーションをアンインストールしたりした場合は、資金を回収するために秘密のフレーズが必要になります。"),
        "securityHeader": MessageLookupByLibrary.simpleMessage("Security"),
        "send": MessageLookupByLibrary.simpleMessage("送信"),
        "sendError":
            MessageLookupByLibrary.simpleMessage("エラーが発生しました。後でもう一度お試しください。"),
        ...
        "tooManyFailedAttempts":
            MessageLookupByLibrary.simpleMessage("ロック解除の試行に失敗した回数が多すぎます。"),
        ...
        "transactionInfosKeyNFTLedger":
            MessageLookupByLibrary.simpleMessage("NFT Ledger"),
        ...
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("トランザクションは正常に送信されました"),
        ...
        "txListTypeTransactionLabelReceive":
            MessageLookupByLibrary.simpleMessage("受信"),
        ...
        "unlockBiometrics":
            MessageLookupByLibrary.simpleMessage("ロックを解除するための認証"),
        "unlockNFCYubikey":
        ...
        "walletFAQDesc":
            MessageLookupByLibrary.simpleMessage("質問があります？最初にここをチェックしてください！"),
