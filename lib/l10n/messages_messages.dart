...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "recoveryPhraseIntroExplanation" : MessageLookupByLibrary.simpleMessage("Here is the list of 24 words to remember. The following screen will prompt you to find them in order to help you verify that you have written them down correctly. This list will also be available in your wallet in the \"Security\" menu."),
