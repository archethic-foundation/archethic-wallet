...
class HivePreferencesDatasource {
  ...
  Future<void> setHasNotSeenRootWarning() => _setValue(hasShownRootWarning, false);
  ...
  Future<void> setActiveRPCServer(bool value) => _setValue(activeRPCServer, value);
  ...
  int getMainScreenCurrentPage() => _getValue(mainScreenCurrentPage, defaultValue: 2);
  ...
  MarketPriceHistoryInterval getPriceChartIntervalOption() => MarketPriceHistoryInterval.values[_getValue(
        priceChartScale,
        defaultValue: MarketPriceHistoryInterval.hour.index,
      )];

  Future<void> setLockTimeout(LockTimeoutOption lockTimeoutOption) => _setValue(lockTimeout, lockTimeoutOption.index);
