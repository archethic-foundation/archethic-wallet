...
class HoneyOrangeTheme implements BaseTheme {
  ...
  // Menu
  @override
  Color? iconDrawer = const Color(0xFFEDA30F);
  @override
  Color? iconDrawerBackground = const Color(0xFFFFFFFF).withOpacity(0.2);
  @override
  Color? drawerBackground = const Color(0xFF6C1E1E);
  ...
  // Sheet
  @override
  Color? sheetBackground = const Color(0xFF6C1E1E).withOpacity(0.7);

  // SnackBar
  @override
  Color? snackBarShadow = const Color(0xFF6C1E1E).withOpacity(0.8);

  // Background
  @override
  Color? backgroundMainTop = const Color(0xFF6C1E1E);
  @override
  Color? backgroundMainBottom = const Color(0xFF6C1E1E);
  @override
  Color? background = const Color(0xFF6C1E1E);
  @override
  Color? background40 = const Color(0xFF6C1E1E).withOpacity(0.4);
  @override
  ...
  @override
  Color? backgroundRecentTxListCardTransferInput = Colors.greenAccent[400]!.withOpacity(0.2);
  @override
  ...
  @override
  Color? bottomBarActiveIconColor = const Color(0xFF6C1E1E);
  @override
  ...
  @override
  String? background1Small = 'assets/themes/honey_orange/v01-waves.jpg';
  @override
  String? background2Small = 'assets/themes/honey_orange/v02-waves.jpg';
  @override
  String? background3Small = 'assets/themes/honey_orange/v03-waves.jpg';
  @override
  String? background4Small = 'assets/themes/honey_orange/v04-waves.jpg';
  @override
  String? background5Small = 'assets/themes/honey_orange/v05-waves.jpg';

  // Animation Overlay
  @override
  Color? animationOverlayMedium = const Color(0xFF6C1E1E).withOpacity(0.7);
  @override
  Color? animationOverlayStrong = const Color(0xFF6C1E1E).withOpacity(0.85);

  @override
  Color? overlay30 = const Color(0xFF6C1E1E).withOpacity(0.3);

  @override
  Color? numMnemonicBackground = const Color(0xFF6C1E1E);
  ...
  @override
  Color? activeColorSwitch = const Color(0xFFEDA30F);
  ...
  @override
  String? assetsFolder = 'assets/themes/honey_orange/';
  @override
  String? logo = 'logo';
  @override
      ...
      border: GradientBoxBorder(
        gradient: LinearGradient(
          colors: [
            ...
            const Color(0xFFEDA30F).withOpacity(0.3),
            const Color(0xFF6C1E1E).withOpacity(0.5),
          ],
