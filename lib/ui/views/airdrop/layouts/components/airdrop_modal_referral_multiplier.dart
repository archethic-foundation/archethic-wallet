...
import 'package:aewallet/ui/views/airdrop/layouts/components/airdrop_referral_step_tab.dart';
...
class AirdropModalReferralMultiplier extends ConsumerWidget {
  const AirdropModalReferralMultiplier({
    super.key,
  });
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      localizations.airdropReferralMultiplierTableDesc,
                    ...
                    aedappfm.BlockInfo(
                      ...
                      info: Row(
                        ...
                        children: [
                          Text(
                            localizations.airdropReferralMultiplierTableLPValue,
                    ...
                    aedappfm.BlockInfo(
                      ...
                      info: Row(
                        ...
                        children: [
                          Text(
                            localizations
                                .airdropReferralMultiplierTableYourLPValue,
                            style: Theme.of(context).textTheme.bodyMedium,
                          ),
                          Text(
        ...
        Align(
          ...
          child: Padding(
            ...
            child: BtnFooterPrimary(
              buttonText: localizations.airdropReferralMultiplierTableHeaderBtn,
              onTap: () async {
                await ref
