  ...
  Widget getFloatingActionButton(BuildContext context, WidgetRef ref) {
    ...
    return AppButtonTinyConnectivity(
      ...
      onPressed: () async {
        ...
        final result = await formNotifier.updateDiscussion(ref, context);
  ...
  Widget getSheetContent(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      children: <Widget>[
        ...
        TextButton(
          onPressed: () async {
            final updateDiscussionAddMembers = UpdateDiscussionAddMembers(
              listMembers: formState.listMembers,
            );
            if (await updateDiscussionAddMembers.canAddNewMembers(ref) ==
                false) {
              UIUtil.showSnackbar(
                              ...
                              children: <Widget>[
                                Text(
                                  accessRecipient.maybeMap(
                                    data: (data) =>
                                        data.value.format(localizations),
                                    orElse: () => '...',
                                  ),
                                    ...
                                    IconButton(
                                      icon: Row(
                                        children: [
                                          ...
                                          Text(
                                            localizations.removeDiscussion,
                                            style: ArchethicThemeStyles
                                                .textStyleSize14W700Primary,
                                          ),
                                        ],
                  ...
                  contact: (contact) => () {
                    ...
                    context.push(
                      ...
                      extra: ContactDetailsRouteParams(
                        contactAddress: contact.contact.genesisAddress!,
                      ).toJson(),
                    );
                  },
                  publicKey: (_) => null,
