...
class BridgeSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BridgeSheet> createState() => BridgeSheetState();
}

class BridgeSheetState extends ConsumerState<BridgeSheet>
  ...
  void initState() {
    Future.delayed(Duration.zero, () async {
      ...
      if (connectivityStatusProvider == ConnectivityStatus.isConnected &&
          BridgeSheet.isAvailable) {
        setState(() {
          aeSwapUrl = 'https://bridge.testnet.archethic.net/';
        });
      }
    });
    super.initState();
