...
class SettingsSheetBin extends StatefulWidget {
  const SettingsSheetBin({Key? key}) : super(key: key);

  @override
  _SettingsSheetBinState createState() => _SettingsSheetBinState();
}

class _SettingsSheetBinState extends State<SettingsSheetBin>
