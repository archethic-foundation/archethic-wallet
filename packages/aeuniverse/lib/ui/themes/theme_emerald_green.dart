...
class EmeraldGreenTheme implements BaseTheme {
  ...
  @override
  Color? iconDataWidgetIcon = Color(0xFF228B77);

  // Menu
  @override
  Color? iconDrawer = Color(0xFF228B77);
  @override
  Color? iconDrawerBackground = Color(0xFFFFFFFF).withOpacity(0.1);
  @override
  Color? drawerBackground = Color(0xFF473B53);
  ...
  // Icons TextField
  Color? textFieldIcon = Color(0xFF228B77);
  ...
  // Sheet
  @override
  Color? sheetBackground = Color(0xFF473B53).withOpacity(0.7);

  // SnackBar
  @override
  Color? snackBarShadow = Color(0xFF473B53).withOpacity(0.8);

  // Background
  @override
  Color? backgroundMainTop = Color(0xFF473B53);
  @override
  Color? backgroundMainBottom = Color(0xFF473B53);
  @override
  Color? background = Color(0xFF473B53);
  @override
  Color? background40 = Color(0xFF473B53).withOpacity(0.4);
  @override
  Color? backgroundDark = Color(0xFF473B53);
  @override
  Color? backgroundDark00 = Color(0xFF473B53).withOpacity(0.0);
  @override
  Color? backgroundDarkest = Color(0xFF228B77);
  ...
  String? background2Small =
      'packages/core_ui/assets/themes/emerald_green/v02-waves-1100.jpg';
  @override
  String? background3Small =
      'packages/core_ui/assets/themes/emerald_green/v03-waves-1100.jpg';
  @override
  String? background4Small =
      'packages/core_ui/assets/themes/emerald_green/v04-waves-1100.jpg';
  @override
  String? background5Small =
      'packages/core_ui/assets/themes/emerald_green/v05-waves-1100.jpg';

  // Animation Overlay
  @override
  Color? animationOverlayMedium = Color(0xFF473B53).withOpacity(0.7);
  @override
  Color? animationOverlayStrong = Color(0xFF473B53).withOpacity(0.85);
  ...
  @override
  String? assetsFolder = 'packages/core_ui/assets/themes/emerald_green/';
  @override
  String? logo = 'logo';
  @override
