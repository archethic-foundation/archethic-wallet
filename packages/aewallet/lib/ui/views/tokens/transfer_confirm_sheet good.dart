...
class _TransferConfirmSheetState extends State<TransferConfirmSheet> {
  ...
  void initState() {
    ...
    subscriptionChannel.onMessage.listen(_onEvent);
...
/*
      ...
      for (UCOTransfer transfer in _ucoTransferList) {
      ...
      Push push = subscriptionChannel
          .addSubscriptionTransactionConfirmed(transaction.address!);

      await for (var message in subscriptionChannel.channel!.messages) {
