          ...
          size_t      size)     /* I - Size of destination string buffer */
{
  ...
  */
  ...
  return (srclen);
   ...
   static void format_flags(char *ret, size_t retlen, uint8_t flags)
   {
       memset(ret, 0, retlen);
 ...
 */
 ...
 static void print_attr(const fido_dev_t *dev)
 {
     char flags_txt[128];
 ...
 */
 ...
 static void print_algorithms(const fido_cbor_info_t *ci)
 {
...
static void getinfo(const char * path)
{
    fido_dev_t *dev;
    fido_cbor_info_t *ci;
    int r;
